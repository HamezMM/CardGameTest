...
mechanics (crab action effects, equipment targeting, etc.), and an open finding that
2-player games can't reach 70% via minion count alone — re-run `tools/balance_simulation.py`
